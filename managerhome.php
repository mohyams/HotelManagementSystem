                ...
                <!-- Brand and toggle get grouped for better mobile display -->
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        <ul class="nav navbar-nav main-nav  clear navbar-right ">
                            ...
                            <li><a class="color_animation" href="Login_v8/orderdetail.html" >ORDER DETAILS</a></li>
                             <li><a class="color_animation" href="managermenu.php" >MENU</a></li>
        ...
        <div id="top" class="starter_container bg">
            <div class="follow_container">
                <div class="col-md-6 col-md-offset-3">
                    ...
                    <h2 class="white second-title">Welcome To</h2>
                     <h2 class="top-title"> Rasoie</h2>
                    <hr>
                    <h2 class="white second-title">A Delicious Solution Of Your Hunger<h2>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-4 col-sm-4 wow fadeInUp" data-wow-delay="0.6s">
                ...
                <ul class="social-icon">
                    <li><a href="https://www.facebook.com/rasoie.restaurant/?ref=br_rs" class="fa fa-facebook wow bounceIn" data-wow-delay="0.3s"></a></li>
