                ...
                <!-- Brand and toggle get grouped for better mobile display -->
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        <ul class="nav navbar-nav main-nav  clear navbar-right ">
                            <li><a class="color_animation" href="recomm.php">RECOMMENDATIONS</a></li>
                            ...
                            <li><a class="color_animation" href="contact1.html">CONTACT</a></li>
                             <li><a class="navactive color_animation" href="newmenu.php">MENU</a></li>
  ...
  <nav1>
    <h3 align="center" style="color:white">MENU</h3><br />  
                ...
                <div class="col-md-4" style="display:inline-block;">  
                     <form method="post" action="newmenu.php?action=add&id=<?php echo $row["ID"]; ?>">  
      ...
      <h4>Cart &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="price" style="color:black"><i class="fa fa-shopping-cart"></i> <b>Price</b></span></h4>
                        <table>  
                          ...
                          <tr>  
                               ...
                               <td align="center">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="newmenu.php?action=delete&id=<?php echo $values["item_id"]; ?>"><span class="text-danger">Remove</span></a></td> 
                               <td colspan="5">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo number_format($values["item_quantity"] * $values["item_price"], 2); ?></td>
                          </tr>  
                          <?php  
                                    $total = $total + ($values["item_quantity"] * $values["item_price"]); 
                                    $quan = $quan + $values["item_quantity"];
                               }  
                          ?>  
                          <tr>  
                            ...
                            <tr>
                                <td colspan="6" class="text-danger" align="right">
                          <?php
                              if($quan<5)
            {
                echo "<br>";
                ...
                echo "<br>";
                echo "Your Order is being made";
                
            }
            elseif(($quan>5) and ($quan<10))
            {
                echo "<br>";
            ...
            {   echo "<br>";
                echo "Please Wait for 15 minutes";
                echo "<br>";
                echo "Your Order is being made";
            }
...
<form action="newmenu.php" method="post">
    ...
    <input type="text" name="tableno" size="6" required maxlength="6" placeholder="Table No">
    </form>
                </div>  
      </div>
  </article>
